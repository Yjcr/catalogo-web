...
class Categorias(models.Model):
    ...
    nombrecategoria = models.CharField(
        db_column="NombreCategoria", max_length=15, blank=True, null=True
    )  # Field name made lowercase.
    descripcioncategoria = models.TextField(
        db_column="DescripcionCategoria", blank=True, null=True
    )  # Field name made lowercase.
...
class Clientes(models.Model):
    idcliente = models.AutoField(
        db_column="IDCliente", primary_key=True
    )  # Field name made lowercase.
    idusuario = models.ForeignKey(
        "Usuarios", models.DO_NOTHING, db_column="IDUsuario"
    )  # Field name made lowercase.
    idubicacion = models.ForeignKey(
        "Ubicaciones", models.DO_NOTHING, db_column="IDUbicacion"
    )  # Field name made lowercase.
...
class Desarrolladoras(models.Model):
    iddesarrolladora = models.AutoField(
        db_column="IDDesarrolladora", primary_key=True
    )  # Field name made lowercase.
    nombredesarrolladora = models.CharField(
        db_column="NombreDesarrolladora", blank=True, null=True
    )  # Field name made lowercase.
    descripciondes = models.TextField(
        db_column="DescripcionDes", blank=True, null=True
    )  # Field name made lowercase.
    sitioweb = models.TextField(
        db_column="SitioWeb", blank=True, null=True
    )  # Field name made lowercase.

    def __str__(self):
        return self.nombredesarrolladora if self.nombredesarrolladora else "Sin nombre"
...
class Detallesfactura(models.Model):
    iddetallefactura = models.IntegerField(
        db_column="IDDetalleFactura", primary_key=True
    )  # Field name made lowercase.
    idfactura = models.ForeignKey(
        "Facturas", models.DO_NOTHING, db_column="IDFactura", blank=True, null=True
    )  # Field name made lowercase.
    idvideojuego = models.ForeignKey(
        "Videojuegos",
        models.DO_NOTHING,
        db_column="IDVideojuego",
        blank=True,
        null=True,
    )  # Field name made lowercase.
...
class Empleados(models.Model):
    idempleado = models.AutoField(
        db_column="IDEmpleado", primary_key=True
    )  # Field name made lowercase.
    idusuario = models.ForeignKey(
        "Usuarios", models.DO_NOTHING, db_column="IDUsuario"
    )  # Field name made lowercase.
    ...
    notas = models.TextField(
        db_column="Notas", blank=True, null=True
    )  # Field name made lowercase.
...
class Facturas(models.Model):
    idfactura = models.AutoField(
        db_column="IDFactura", primary_key=True
    )  # Field name made lowercase.
    idpago = models.ForeignKey(
        "Pagos", models.DO_NOTHING, db_column="IDPago"
    )  # Field name made lowercase.
    idempleado = models.ForeignKey(
        Empleados, models.DO_NOTHING, db_column="IDEmpleado"
    )  # Field name made lowercase.
    idcliente = models.ForeignKey(
        Clientes, models.DO_NOTHING, db_column="IDCliente"
    )  # Field name made lowercase.
    fechafactura = models.DateField(
        db_column="FechaFactura", blank=True, null=True
    )  # Field name made lowercase.
    total = models.DecimalField(
        db_column="Total", max_digits=10, decimal_places=2, blank=True, null=True
    )  # Field name made lowercase.
...
class Favoritos(models.Model):
    idfavorito = models.IntegerField(
        db_column="IDFavorito", primary_key=True
    )  # Field name made lowercase.
    idusuario = models.ForeignKey(
        "Usuarios", models.DO_NOTHING, db_column="IDUsuario"
    )  # Field name made lowercase.
    idvideojuego = models.ForeignKey(
        "Videojuegos", models.DO_NOTHING, db_column="IDVideojuego"
    )  # Field name made lowercase.
    fechaagregado = models.DateField(
        db_column="FechaAgregado", blank=True, null=True
    )  # Field name made lowercase.
...
class Pagos(models.Model):
    idpago = models.AutoField(
        db_column="IDPago", primary_key=True
    )  # Field name made lowercase.
    idcliente = models.ForeignKey(
        Clientes, models.DO_NOTHING, db_column="IDCliente"
    )  # Field name made lowercase.
    referencia = models.CharField(
        db_column="Referencia", blank=True, null=True
    )  # Field name made lowercase.
    capturapago = models.TextField(
        db_column="CapturaPago", blank=True, null=True
    )  # Field name made lowercase.
    metodopago = models.CharField(
        db_column="MetodoPago", max_length=20, blank=True, null=True
    )  # Field name made lowercase.
    fechapago = models.DateField(
        db_column="FechaPago", blank=True, null=True
    )  # Field name made lowercase.
    monto = models.DecimalField(
        db_column="Monto", max_digits=10, decimal_places=5, blank=True, null=True
...
class Promociones(models.Model):
    idpromocion = models.IntegerField(
        db_column="IDPromocion", primary_key=True
    )  # Field name made lowercase.
    idvideojuego = models.ForeignKey(
        "Videojuegos",
        models.DO_NOTHING,
    ...
    descuento = models.DecimalField(
        db_column="Descuento", max_digits=5, decimal_places=2, blank=True, null=True
    )  # Field name made lowercase.
    fechainicio = models.DateField(
        db_column="FechaInicio", blank=True, null=True
    )  # Field name made lowercase.
    fechafin = models.DateField(
        db_column="FechaFin", blank=True, null=True
    )  # Field name made lowercase.
...
class Reseñas(models.Model):
    idreseña = models.AutoField(
        db_column="IDReseña", primary_key=True
    )  # Field name made lowercase.
    ...
    calificacion = models.SmallIntegerField(
        db_column="Calificacion", blank=True, null=True
    )  # Field name made lowercase.
    fechareseña = models.DateField(
        db_column="FechaReseña", blank=True, null=True
    )  # Field name made lowercase.
...
class Ubicaciones(models.Model):
    idubicacion = models.AutoField(
        db_column="IDUbicacion", primary_key=True
    )  # Field name made lowercase.
    direccion = models.CharField(
        db_column="Direccion", max_length=50, blank=True, null=True
    )  # Field name made lowercase.
    estado = models.CharField(
        db_column="Estado", max_length=20, blank=True, null=True
    )  # Field name made lowercase.
    ciudad = models.CharField(
        db_column="Ciudad", max_length=25, blank=True, null=True
    )  # Field name made lowercase.
    codpostal = models.CharField(
        db_column="CodPostal", max_length=15, blank=True, null=True
    )  # Field name made lowercase.
...
class Usuarios(models.Model):
    ...
    nombre = models.CharField(
        db_column="Nombre", max_length=10, blank=True, null=True
    )  # Field name made lowercase.
    apellido = models.CharField(
        db_column="Apellido", max_length=10, blank=True, null=True
    )  # Field name made lowercase.
    cedula = models.CharField(
        db_column="Cedula", max_length=20, blank=True, null=True
    )  # Field name made lowercase.
    nacimiento = models.DateField(
        db_column="Nacimiento", blank=True, null=True
    )  # Field name made lowercase.
    email = models.CharField(
        db_column="Email", max_length=254, blank=True, null=True
    )  # Field name made lowercase.
    telefono = models.CharField(
        db_column="Telefono", max_length=20, blank=True, null=True
    )  # Field name made lowercase.
    nombreusuario = models.CharField(
        db_column="NombreUsuario", max_length=15, blank=True, null=True
    )  # Field name made lowercase.
    contraseña = models.CharField(
        db_column="Contraseña", max_length=15, blank=True, null=True
    )  # Field name made lowercase.
    rol = models.TextField(
        db_column="Rol", blank=True, null=True
...
class Videojuegos(models.Model):
    idvideojuego = models.AutoField(
        db_column="IDVideojuego", primary_key=True
    )  # Field name made lowercase.
    nombre = models.CharField(
    ...
    iddesarrolladora = models.ForeignKey(
        Desarrolladoras,
        on_delete=models.SET_NULL,
        db_column="IDDesarrolladora",
        blank=True,
        null=True,
    )  # Field name made lowercase.
